...
//     // Función para generar datos aleatorios de performance
...
//         // Seleccionar 4 títulos aleatorios
...
//             rate: Math.floor(Math.random() * 50) + 50 // Rango entre 50-100
//         }));
//     };

//     // Función para generar un ID único
//     const generateBotId = () => {
//         const randomNum = Math.floor(Math.random() * 900) + 100; // Número entre 100-999
//         return `BOT-${randomNum}`;
//     };

//     const handleFormSubmit = (data: FormData) => {
//         // Convertir los strings de arrays a arrays reales
//         const processesSteps = data.processes.split(',').map(item => item.trim());
//         const automatedActions = data.automatedActions.split(',').map(item => item.trim());
//         const integrations = data.integrations.split(',').map(item => item.trim());
//         const dataTypes = data.dataTypes.split(',').map(item => item.trim());
...
//             type: data.type,
//             status: "active",
//             completeRate: Math.floor(Math.random() * 30) + 70, // Rango entre 70-100
//             intervalTime: 5000,
//             processes: {
//                 name: data.workflowTitle,
//                 steps: processesSteps,
//                 automatedActions: automatedActions,
//                 integrations: integrations,
//                 frequency: "Por solicitud",
//                 dataTypes: dataTypes,
//                 workflow: processesSteps.map(step => `Ejecuta: ${step}`)
//             }
//         };
//         console.log(newBot)
//         // Obtener bots existentes o inicializar array
...
//                     </CRow>
//                     <CRow>
//                         <CCol className="text-start py-1" md={12}>
//                             <CustomInput
//                                 size="sm"
//                                 label="Nombre de RPA´s"
//                                 type="text"
//                                 id="name"
//                                 register={register}
//                                 validationRules={{
...
//                                 required={true}
//                                 placeholder="Ej: Autenticador Automático"
//                             />
//                         </CCol>
...
//                             <CustomInput
//                                 size="sm"
//                                 label="Título de flujo de trabajo"
//                                 type="text"
//                                 id="workflowTitle"
//                                 register={register}
//                                 validationRules={{
...
//                                     }
//                                 }}
//                                 errorMessage={errors.workflowTitle?.message as string}
//                                 required={true}
...
//                             <CustomInput
//                                 size="sm"
//                                 label="Procesos involucrados (separados por comas)"
//                                 type="text"
//                                 id="processes"
//                                 register={register}
//                                 validationRules={{
//                                     required: "Los procesos son obligatorios",
//                                     minLength: {
//                                         value: 10,
//                                         message: "Debe especificar al menos un proceso"
//                                     }
//                                 }}
//                                 errorMessage={errors.processes?.message as string}
//                                 required={true}
//                                 placeholder="Ej: Captura credenciales, Valida en base de datos, Genera token JWT"
//                             />
//                         </CCol>
...
//                             <CustomInput
//                                 size="sm"
//                                 label="Acciones a automatizar (separadas por comas)"
//                                 type="text"
//                                 id="automatedActions"
//                                 register={register}
//                                 validationRules={{
...
//                                     }
//                                 }}
//                                 errorMessage={errors.automatedActions?.message as string}
//                                 required={true}
//                                 placeholder="Ej: Autenticación en segundo plano, Generación automática de tokens"
//                             />
//                         </CCol>
...
//                             <CustomInput
//                                 size="sm"
//                                 label="Aplicaciones a Integrar (separadas por comas)"
//                                 type="text"
//                                 id="integrations"
//                                 register={register}
//                                 validationRules={{
//                                     required: "Las integraciones son obligatorias",
//                                     minLength: {
//                                         value: 3,
//                                         message: "Debe especificar al menos una integración"
//                                     }
//                                 }}
//                                 errorMessage={errors.integrations?.message as string}
//                                 required={true}
//                                 placeholder="Ej: Okta, Active Directory, Auth0"
//                             />
//                         </CCol>
...
//                             <CustomInput
//                                 size="sm"
//                                 label="Tipos de datos involucrados (separados por comas)"
//                                 type="text"
//                                 id="dataTypes"
//                                 register={register}
//                                 validationRules={{
//                                     required: "Los tipos de datos son obligatorios",
//                                     minLength: {
//                                         value: 3,
//                                         message: "Debe especificar al menos un tipo de dato"
//                                     }
//                                 }}
//                                 errorMessage={errors.dataTypes?.message as string}
//                                 required={true}
//                                 placeholder="Ej: credenciales, tokens, logs de acceso"
//                             />
//                         </CCol>
//                     </CRow>
//                 </CModalBody>
